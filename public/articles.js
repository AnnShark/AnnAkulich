...
function startApp() {
   ...
   // makeArticles(0,20);
    var total = articlesBlok.getArticlesCount();
       ...
       // aside.addEventListener('click',deligateClickEventAside);


        /* Нарисуем статьи из массива GLOBAL_ARTICLES в DOM */
        makeArticles(paginationParams.skip, paginationParams.top);
}
//function deligateClickEventAside(eventObj){
//    var classList = eventObj.target.classList;
//        if(eventObj.type ==='click' && classList.contains('button')){
//            filterAdd(eventObj);
//        }
//}
//function filterAdd(eventObj){
//var add = eventObj.target.parentNode;
//var addId = add.getAttribute('date-id');
//var article = articlesBlok.getArticles(skip,top,addId);
//add.getElementsByClassName('article')[0].textContent = article.aside;
//}
