...
let articlesBlok = (function () {
    ...
    if(!articles){
        ...
        articles = [article1, article2, article3, article4, article5, article6, article7, article8, article9, article10, article11, article12,
            article13, article14, article15, article16, article17, article18, article19, article20
        ];
        let tags = localStorage.setItem('tags',JSON.stringify(tags));
        if(!tags){
...
function createNewsButton() {
    let col = document.querySelectorAll(".editArticleButton");
    let arr = document.querySelectorAll(".deleteArticleButton").forEach((button) => {
        ...
        button.addEventListener('click', function () {
            ...
            makeArticles(0, 4);
            let total = articlesBlok.getArticlesCount();
    ...
    for (let i = 0; i < col.length; i++) {
        ...
        (function (a) {
            col[a].addEventListener('click', function (e) {
                let article = articlesBlok.getArticle((this.getAttribute('data-id')));
                ...
                document.querySelector(".edit-form").style.visibility = "visible";
                 ...
                 document.querySelector(".edit-form .editOk").addEventListener('click', function () {
                    ...
                    let arr = document.querySelector(".add-form .tags").value.split(",");
                    article.tags=arr;
...
function startApp() {
    ...
    let total = articlesBlok.getArticlesCount();
    let paginationParams = pagination.init(total, makeArticles);
    ...
    document.querySelector(".login-form .ok").addEventListener('click', function () {
        user = {
            name: "",
            password: ""
        };
    ...
    document.querySelector(".add-form .ok").addEventListener('click', function () {
        newAddArticle = {
            title: "",
            author: "",
            createdAt: new Date(),
    ...
    //  function  fAddNewArticle() {
    //    newAddArticle = {title:"",author:"",createdAt:new Date(),summary:"",tags:[],content:""};
    //    newAddArticle.id = document.querySelector(".add-form .id").value;
    //    newAddArticle.title = document.querySelector(".add-form .title").value;
    //    newAddArticle.author = document.querySelector(".add-form .author").value;
    ...
    document.querySelector(".add-form .cancel").addEventListener('click', function () {
        document.querySelector(".add-form").style.visibility = "hidden";
    });



    document.querySelector(".edit-form .editCancel").addEventListener('click', function () {
        document.querySelector(".edit-form").style.visibility = "hidden";
    });
...
function deligateClickEvent(eventObj) {
    let classList = eventObj.target.classList;
...
function readMore(eventObj) {
    let news = eventObj.target.parentNode;
    let id = news.getAttribute('data-id');
    let article = articlesBlok.getArticle(id);
